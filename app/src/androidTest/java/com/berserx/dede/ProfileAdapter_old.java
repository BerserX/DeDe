 ...
 */
public class ProfileAdapter_old extends ArrayAdapter<Profile> {

    private String[] properties = {"Alias", "Broadcast"};
    public ProfileAdapter_old(Context context, ArrayList<Profile> profile) {
